...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-5.2-4
...
plcapi-GITPATH                  := git://git.onelab.eu/plcapi.git@plcapi-5.2-7
...
sliceimage-GITPATH              := git://git.onelab.eu/sliceimage.git@sliceimage-5.1-5
...
tests-GITPATH                   := git://git.onelab.eu/tests.git@tests-5.2-6
