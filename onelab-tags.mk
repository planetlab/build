...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-2.1-15
...
###
sfa-GITPATH                     := git://git.onelab.eu/sfa.git@sfa-2.1-21
...
tests-GITPATH                   := git://git.onelab.eu/tests.git@tests-5.1-8
