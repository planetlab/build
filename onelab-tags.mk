...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-2.1-10
...
vsys-scripts-GITPATH            := git://git.onelab.eu/vsys-scripts.git@vsys-scripts-0.95-44
autoconf-GITPATH		:= git://git.onelab.eu/autoconf@autoconf-2.69-1
sliver-openvswitch-GITPATH      := git://git.onelab.eu/sliver-openvswitch.git@sliver-openvswitch-1.8.90-4
plcapi-GITPATH                  := git://git.onelab.eu/plcapi.git@plcapi-5.1-3
drupal-GITPATH                  := git://git.onelab.eu/drupal.git@drupal-4.7-15
plewww-GITPATH                  := git://git.onelab.eu/plewww.git@plewww-4.3-74
...
###
sfa-GITPATH                     := git://git.onelab.eu/sfa.git@sfa-2.1-15
sface-GITPATH                   := git://git.onelab.eu/sface.git@sface-0.9-8
...
sliceimage-GITPATH              := git://git.onelab.eu/sliceimage.git@sliceimage-5.1-2
nodeimage-GITPATH               := git://git.onelab.eu/nodeimage.git@nodeimage-2.1-2
