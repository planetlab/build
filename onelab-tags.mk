...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-5.2-7
...
sliver-openvswitch-GITPATH      := git://git.onelab.eu/sliver-openvswitch.git@openvswitch-1.11.90-1
plcapi-GITPATH                  := git://git.onelab.eu/plcapi.git@plcapi-5.2-8
drupal-GITPATH                  := git://git.onelab.eu/drupal.git@drupal-4.7-15
plewww-GITPATH                  := git://git.onelab.eu/plewww.git@plewww-5.2-3
...
myplc-GITPATH                   := git://git.onelab.eu/myplc.git@myplc-5.2-4
...
tests-GITPATH                   := git://git.onelab.eu/tests.git@tests-5.2-8
