...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-2.1-11
...
sliver-openvswitch-GITPATH      := git://git.onelab.eu/sliver-openvswitch.git@sliver-openvswitch-1.8.90-5
