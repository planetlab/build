...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-5.2-8
...
plcapi-GITPATH                  := git://git.onelab.eu/plcapi.git@plcapi-5.2-10
...
myplc-GITPATH                   := git://git.onelab.eu/myplc.git@myplc-5.2-5
DistributedRateLimiting-SVNPATH	:= http://svn.planet-lab.org/svn/DistributedRateLimiting/tags/DistributedRateLimiting-0.1-1

#
sfa-GITPATH                     := git://git.onelab.eu/sfa.git@sfa-2.1-27
