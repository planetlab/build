...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-5.2-9
...
plcapi-GITPATH                  := git://git.onelab.eu/plcapi.git@plcapi-5.3-1
...
nodeconfig-GITPATH              := git://git.onelab.eu/nodeconfig.git@nodeconfig-5.2-3
