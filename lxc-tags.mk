...
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-5.2-10
#
...
libvirt-GITPATH                 := git://git.onelab.eu/libvirt.git@libvirt-1.2.1-1
libvirt-python-GITPATH          := git://git.onelab.eu/libvirt-python.git@libvirt-python-1.2.1-1
...
sliver-openvswitch-GITPATH      := git://git.onelab.eu/sliver-openvswitch.git@sliver-openvswitch-2.1.90-1
