...
lxc-userspace-GITPATH           := git://git.planet-lab.org/lxc-userspace.git@lxc-userspace-1.0-1
...
###
rvm-ruby-GITPATH                := git://git.onelab.eu/rvm-ruby.git@rvm-ruby-1.20.10-5
...
#
tests-GITPATH                   := git://git.onelab.eu/tests.git@tests-5.2-5
