...
lxc-userspace-GITPATH           := git://git.planet-lab.org/lxc-userspace.git@lxc-userspace-1.0-5
...
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-5.2-5
#
...
vsys-scripts-GITPATH            := git://git.planet-lab.org/vsys-scripts.git@vsys-scripts-0.95-47
...
plcapi-GITPATH                  := git://git.planet-lab.org/plcapi.git@plcapi-5.2-7
