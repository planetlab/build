...
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-2.1-17
...
plewww-GITPATH			:= git://git.planet-lab.org/plewww@plewww-4.3-74
...
###
sfa-GITPATH                     := git://git.planet-lab.org/sfa.git@sfa-2.1-22
...
bootmanager-GITPATH             := git://git.planet-lab.org/bootmanager.git@bootmanager-5.0-24
...
myplc-GITPATH                   := git://git.planet-lab.org/myplc.git@myplc-5.1-5
# locating the right test directory - see make tests_gitpath
tests-GITPATH                   := git://git.planet-lab.org/tests.git@tests-5.1-8
