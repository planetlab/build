...
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-5.2-4
...
vsys-scripts-GITPATH		:= git://git.planet-lab.org/vsys-scripts@vsys-scripts-0.95-47
...
tests-GITPATH                   := git://git.planet-lab.org/tests.git@tests-5.2-6
