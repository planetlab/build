...
linux-2.6-BRANCH		:= 32
linux-2.6-GITPATH		:= git://git.planet-lab.org/linux-2.6.git@linux-2.6-32-29
...
vsys-scripts-GITPATH		:= git://git.planet-lab.org/vsys-scripts@vsys-scripts-0.95-38
plcapi-GITPATH                  := git://git.planet-lab.org/plcapi@master
drupal-GITPATH                  := git://git.planet-lab.org/drupal.git@drupal-4.7-15
plewww-GITPATH			:= git://git.planet-lab.org/plewww@plewww-4.3-71
...
###
sfa-GITPATH                     := git://git.planet-lab.org/sfa.git@sfa-2.1-5
...
bootmanager-GITPATH             := git://git.planet-lab.org/bootmanager.git@bootmanager-5.0-21
pypcilib-GITPATH		:= git://git.planet-lab.org/pypcilib.git@pypcilib-0.2-10
pyplnet-GITPATH                 := git://git.planet-lab.org/pyplnet.git@pyplnet-4.3-13
