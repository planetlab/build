...
linux-2.6-BRANCH		:= 32
linux-2.6-GITPATH		:= git://git.planet-lab.org/linux-2.6.git@linux-2.6-32-33
...
util-vserver-pl-GITPATH		:= git://git.planet-lab.org/util-vserver-pl.git@util-vserver-pl-0.4-27
...
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-2.1-7
...
vsys-scripts-GITPATH		:= git://git.planet-lab.org/vsys-scripts@vsys-scripts-0.95-42
plcapi-GITPATH                  := git://git.planet-lab.org/plcapi@master
drupal-GITPATH                  := git://git.planet-lab.org/drupal.git@drupal-4.7-15
plewww-GITPATH			:= git://git.planet-lab.org/plewww@plewww-4.3-73
...
###
sfa-GITPATH                     := git://git.planet-lab.org/sfa.git@sfa-2.1-13
...
bootmanager-GITPATH             := git://git.planet-lab.org/bootmanager.git@bootmanager-5.0-23
...
myplc-GITPATH                   := git://git.planet-lab.org/myplc.git@myplc-5.1-3
