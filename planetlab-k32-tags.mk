...
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-5.2-9
...
vsys-scripts-GITPATH		:= git://git.planet-lab.org/vsys-scripts@vsys-scripts-0.95-48
plcapi-GITPATH                  := git://git.planet-lab.org/plcapi.git@plcapi-5.2-3
...
bootmanager-GITPATH             := git://git.planet-lab.org/bootmanager.git@bootmanager-5.2-2
...
myplc-GITPATH                   := git://git.planet-lab.org/myplc.git@myplc-5.3-1
# locating the right test directory - see make tests_gitpath
tests-GITPATH                   := git://git.planet-lab.org/tests.git@tests-5.3-1
