...
linux-2.6-BRANCH		:= 27
linux-2.6-GITPATH		:= git://git.planet-lab.org/linux-2.6.git@linux-2.6-27-38
...
iproute2-GITPATH                := git://git.planet-lab.org/iproute2.git@iproute2-2.6.38-1
...
nodemanager-GITPATH             := git://git.planet-lab.org/nodemanager.git@nodemanager-2.0-35
...
vsys-scripts-GITPATH		:= git://git.planet-lab.org/vsys-scripts@vsys-scripts-0.95-37
plcapi-GITPATH                  := git://git.planet-lab.org/plcapi@plcapi-5.0-37
