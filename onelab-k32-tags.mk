...
util-vserver-pl-GITPATH         := git://git.onelab.eu/util-vserver-pl.git@util-vserver-pl-0.4-27
...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-2.1-7
...
mom-GITPATH			:= git://git.onelab.eu/mom.git@master
...
###
sfa-GITPATH                     := git://git.onelab.eu/sfa.git@sfa-2.1-13
...
bootmanager-GITPATH             := git://git.onelab.eu/bootmanager.git@bootmanager-5.0-23
