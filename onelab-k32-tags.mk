...
nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-2.1-6
...
###
sfa-GITPATH                     := git://git.onelab.eu/sfa.git@sfa-2.1-12
...
myplc-GITPATH                   := git://git.onelab.eu/myplc.git@myplc-5.1-3
