...
###
linux-2.6-BRANCH		:= 32
linux-2.6-GITPATH		:= git://git.onelab.eu/linux-2.6.git@linux-2.6-32-29
...
vsys-scripts-GITPATH            := git://git.onelab.eu/vsys-scripts.git@vsys-scripts-0.95-38
...
###
sfa-GITPATH                     := git://git.onelab.eu/sfa.git@sfa-2.1-5
...
pyplnet-GITPATH                 := git://git.onelab.eu/pyplnet.git@pyplnet-4.3-13
